...
Destination.create(name="肉の米内（精肉店）",address="岩手県盛岡市紺屋町５−１６",contents="紹介文",access="盛岡都心循環バス「でんでんむし」で上の橋バス停下車徒歩1分",parkingarea="無料駐車場はございませんので、近隣のパーキングをご利用ください。",closeddays="日曜日	10時00分～18時00分、月曜日	10時00分～18時00分、火曜日	10時00分～18時00分、水曜日	10時00分～18時00分、木曜日	定休日、金曜日	10時00分～18時00分、土曜日10時00分～18時00分、(勤労感謝の日)時間変更の可能性",price="その人その人によりますが、1500円0ほどあれば良いと僕は思います。",cashless="カード不可。現金のみとなっております。")
Destination.create(name="肉の米内（レストラン）",address="岩手県盛岡市紺屋町5-31",contents="紹介文",access="JR盛岡駅→盛岡都心循環バスでんでんむし右回りで13分、上の橋下車、徒歩5分",parkingarea="あり(15台) ※他近隣に提携駐車場10台",closeddays="11:30 - 23:00. L.O. 22:30. □ 定休日第2・4木曜日. 営業時間・定休日は変更となる場合がございますので、ご来店前に店舗にご確認ください",price="その人その人によりますが、5000円0ほどあれば良いと僕は思います。",cashless="可(VISA、JCB、AMEX、銀聯)また、電子マネー不可っs")
Destination.create(name="甘味処鎌倉",address="岩手県盛岡市内丸６−１５",contents="紹介文",access="JR山田線 上盛岡駅 徒歩16分",parkingarea="なし、近隣の有料駐車場をご利用ください",closeddays="11:00 - 18:00 営業時間・定休日は変更となる場合がございますので、ご来店前に店舗にご確認ください。",price="その人その人によりますが、2000円ほどあれば良いと僕は思います。",cashless="可(VISA、JCB、AMEX、銀聯)また、電子マネーも可")